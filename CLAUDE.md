...
## The 17 templates (all in `scripts/30_template_scenario_generator.py`)

| # | Tactic | Verdict | Tier | Indicators | Source |
|---|---|---|---|---|---|
| 1 | credible_policy_announcement | REAL | novice | (none) | Modirrousta-Galian 2023 |
| 2 | urgency_sharing | FAKE | novice | URG+MISS+EMO | Roozenbeek 2019 |
| 3 | historical_revisionism | FAKE | advanced | MISS+REV | Schipper 2025 |
| 4 | historical_revisionism_truth | REAL | novice | (none) | (REAL counterpart) |
| 5 | red_tagging | FAKE | proficient | EMO+FAB+ANON | Arugay 2022 |
| 6 | fake_celebrity_endorsement | FAKE | novice | EMO+ENDO+FAB | Ong & Cabañes 2018 |
| 7 | ambiguous_allegation | UNCERTAIN | proficient | ANON+MISS | Schafer 2024 |
| 8 | conspiracy_theory | FAKE | advanced | CONS+ANON+MISS | DEPICT |
| 9 | polarization_us_vs_them | FAKE | proficient | POL+EMO+MISS | Roozenbeek 2020 (NEW) |
| 10 | discrediting_personal_attack | FAKE | novice | DISC+EMO+ANON | Roozenbeek 2019 (NEW) |
| 11 | fake_account_impersonation | FAKE | advanced | IMP+FAB+ANON | Ong & Cabañes 2018 (NEW) |
| 12 | recycled_old_content | FAKE | novice | RECF+MISS+EMO | Schipper 2025 (NEW) |
| 13 | deepfake_video_claim | FAKE | advanced | FAB+MISS+EMO | Schipper 2025 (NEW) |
| 14 | fake_fact_checker_authority | FAKE | advanced | IMP+FAB+ANON | Tsipursky 2024 (NEW) |
| 15 | coordinated_outrage_campaign | FAKE | proficient | POL+EMO+RECF | Ong & Cabañes 2018 (NEW) |
| 16 | credible_verification_response | REAL | proficient | (none) | (REAL variety, NEW) |
| 17 | developing_situation_unverified | UNCERTAIN | novice | MISS | Schafer 2024 (NEW) |
